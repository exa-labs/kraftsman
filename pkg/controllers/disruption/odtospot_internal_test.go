...
func TestRetrySpotOnlyReplacementsExcludesSpikedZones(t *testing.T) {
	...
	if !c.retrySpotOnlyReplacements("", consolidationSimulationOptions{}, nil, []*pscheduling.NodeClaim{nc}, snapshot, priceBudget{candidatePrice: 13.0}, MinInstanceTypesForSpotToSpotConsolidation, nil) {
...
func TestRetrySpotOnlyReplacementsUsesPerClaimBudgetForSplits(t *testing.T) {
	...
	if !c.retrySpotOnlyReplacements("", consolidationSimulationOptions{}, nil, []*pscheduling.NodeClaim{nc1, nc2}, snapshots, priceBudget{candidatePrice: 13.0}, MinInstanceTypesForSpotToSpotConsolidation, nil) {
