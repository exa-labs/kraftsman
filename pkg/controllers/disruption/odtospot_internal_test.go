...
func TestRetrySpotOnlyReplacementsExcludesSpikedZones(t *testing.T) {
	...
	if !c.retrySpotOnlyReplacements("", consolidationSimulationOptions{}, nil, []*pscheduling.NodeClaim{nc}, snapshot, 13.0, MinInstanceTypesForSpotToSpotConsolidation) {
...
func TestRetrySpotOnlyReplacementsUsesPerClaimBudgetForSplits(t *testing.T) {
	...
	if !c.retrySpotOnlyReplacements("", consolidationSimulationOptions{}, nil, []*pscheduling.NodeClaim{nc1, nc2}, snapshots, 13.0, MinInstanceTypesForSpotToSpotConsolidation) {
